...
final class ArticleCellViewModelTests: XCTestCase {
    ...
    override func setUp() {
        viewModel = ArticleCellViewModel(article: Article(id: UUID().uuidString, author: "David Henderson", title: "An EV Canary in the Coal Mine?", description: "I’ve written before about why I think California is the canary in the coal mine for the success or failure of electric vehicle (EV) mandates.\nNow, based on an experience I had in Phoenix last Thursday", url: "https://www.econlib.org/an-ev-canary-in-the-coal-mine/", urlToImage: "https://www.econlib.org/wp-content/uploads/2023/12/Unknown.jpeg", publishedAt: "2023-12-04T18:46:48Z"))
        
        viewModelWithPartialData = ArticleCellViewModel(article: Article(id: UUID().uuidString, author: nil, title: "Title", description: nil, url: "https://www.SampleURL.com", urlToImage: nil, publishedAt: "2023-12-04"))
    }
